...
* Trained the model with the preprocessed dataset, evaluated and tested.
* I used dash API to develop a dashboard and integrated it with the evaluated model to make future crop predictions based on input data.
* You can have a look at how the final dashboard looks like here <https://app.netlify.com/>
...
* I used the netlify platform to deploy the application for user interaction.
